...
enum class TokenType
{
    ...
    PLUS, MINUS, MULTIPLY, DIVIDE, MODULO, ASSIGN, INCREMENT, DECREMENT,
    ...
    INT_LIT, FLOAT_LIT, DOUBLE_LIT, CHAR_LIT, BOOL_LIT, STRING_LIT, ARRAY_LIT,
    
    FUNC, VAR, RETURN, IF, ELSE, WHILE, DO, FOR, BREAK, CONTINUE, CLASS, PUBLIC, PRIVATE, NEW, THIS, CONSTRUCTOR, ECHO, TRAIT, IMPL, CONST, INCLUDE, SIZEOF,
