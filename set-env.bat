...
if /i "%CMAKE_GENERATOR%" == "Ninja" set CMAKE_USE_ARCH_OPTIONS=
...
set LLVM_CMAKE_CONFIGURE_FLAGS= ^
	...
	%CMAKE_COMPILER_LAUNCHER_FLAGS% ^
	%CMAKE_NINJA_BUILD_TYPE_FLAG% ^
...
set CMAKE_NINJA_BUILD_TYPE_FLAG=
if /i "%CMAKE_GENERATOR%" == "Ninja" set CMAKE_NINJA_BUILD_TYPE_FLAG=-DCMAKE_BUILD_TYPE=%CONFIGURATION%
